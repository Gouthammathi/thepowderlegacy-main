          ...
          <div className="flex justify-between items-center h-18">
            ...
            <div className="flex items-center gap-1">
              ...
              {currentUser ? (
                ...
                <Link 
                  to="/login" 
                  className="hidden lg:flex items-center justify-center w-10 h-10 bg-gradient-to-br from-[#2d5f3f] to-[#1e4029] rounded-full hover:from-[#1e4029] hover:to-[#0f1f15] transition-all shadow-md hover:shadow-lg"
                  aria-label="Login"
                >
