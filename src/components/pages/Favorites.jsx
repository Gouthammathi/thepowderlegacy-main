              ...
              <div key={product.id} className="group h-full flex flex-col bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg transition-all duration-500 ease-in-out border border-gray-100">
                <Link to={`/shop/product/${product.id}`} className="block relative">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 w-7 h-7 bg-white/90 backdrop-blur-sm hover:bg-white rounded-full shadow-md flex items-center justify-center transition-all duration-300 ease-in-out hover:scale-110 hover:bg-red-50"
                    aria-label="Remove"
                  >
                ...
                <div className="p-3 flex flex-col h-full">
                  ...
                  <div className="mt-auto">
                    <div className="text-lg font-bold text-[#2d5f3f] group-hover:scale-105 transition-transform duration-300 ease-in-out mb-2">
                      ₹{product.sizes?.[0]?.price || 0}
                    </div>
                    <span className="text-xs text-[#2d5f3f] hover:text-[#1e4029] font-medium transition-colors">
                      View Details →
                    </span>
                  </div>
                </div>
