    ...
    <div className="space-y-16">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {[
          ...
          {
            name: "Multani Mitti",
            image: "/images/ingredients/multani-mitti.jpg",
          ...
          },
          {
            ...
            benefits: "Hair growth stimulation, scalp nourishment, natural conditioning",
            usage: "Essential in our hair care formulations for stronger hair",
            color: "from-yellow-50 to-green-100"
          },
          {
            name: "Aloe Vera",
            image: "/images/ingredients/aloe-vera.jpg",
            benefits: "Skin hydration, cooling effect, natural healing",
            usage: "Soothing ingredient for sensitive and dry skin",
            color: "from-green-50 to-teal-100"
          },
          {
            name: "Hibiscus",
            image: "/images/ingredients/hibiscus.jpg",
            benefits: "Hair strengthening, natural color enhancement, scalp health",
            usage: "Key ingredient in our hair care products for lustrous hair",
            color: "from-pink-50 to-red-100"
          }
        ].map((ingredient, index) => (
          <div key={index} className="group bg-white/95 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-all duration-300">
            {/* Ingredient Image */}
            <div className={`h-48 bg-gradient-to-br ${ingredient.color} relative overflow-hidden`}>
              <img
            ...
            <div className="p-5">
              <div className="mb-4">
                ...
                <p className="text-gray-600 text-sm leading-relaxed">{ingredient.benefits}</p>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 mb-2 text-sm">Usage:</h4>
                <p className="text-gray-600 text-sm leading-relaxed">{ingredient.usage}</p>
              </div>
            </div>
          </div>
        ))}
