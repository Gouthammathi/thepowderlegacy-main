        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="text-center">
            <div className="text-xs text-stone-300 mb-2">
              © {currentYear} The Powder Legacy. All rights reserved.
            </div>
            <div className="flex justify-center items-center gap-4 text-[10px] text-stone-300">
              <div className="flex items-center gap-1">
                <Leaf size={10} className="text-[#d4a574]" />
                <span>100% Natural</span>
              </div>
              <div className="flex items-center gap-1">
                <Award size={10} className="text-[#d4a574]" />
                <span>Certified</span>
              </div>
            </div>
          </div>
